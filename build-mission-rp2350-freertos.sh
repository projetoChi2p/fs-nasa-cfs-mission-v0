...
JOBS=""
# JOBS="-j 10"
SIMULATION="rp2350-riscv-freertos"
...
export RISCV_MARCH="rv32ima_zicsr_zifencei_zba_zbb_zbs_zbkb_zca_zcb_zcmp"
export RISCV_MABI="ilp32"
export RISCV_GCC_PATH=/opt/riscv-gnu-toolchain-15.1.0-2025.12.27-rp2350
