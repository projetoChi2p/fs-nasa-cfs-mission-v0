...
# adding osal_bsp to MISSION_CORE_MODULES to force whole-archive
#list(APPEND MISSION_CORE_MODULES libosal_bsp)
...
foreach(DYN_APP ${MISSION_GLOBAL_APPLIST})
    ...
    list(APPEND MISSION_GLOBAL_STATIC_APPLIST ${DYN_APP})
endforeach()
