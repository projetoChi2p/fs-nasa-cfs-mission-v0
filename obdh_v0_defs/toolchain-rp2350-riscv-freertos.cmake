...
add_definitions(-DRP2350_RISCV -DCPU_FREQUENCY=150000000UL)
...
if ("${GCCPREFIX}" STREQUAL "")
    set(GCCPREFIX   "riscv32-unknown-elf-")
endif()
...
if ("${RISCV_GCC_PATH}" STREQUAL "")
    find_program(CMAKE_C_COMPILER
        NAMES ${GCCPREFIX}gcc
        HINTS
            "/opt/riscv-gnu-toolchain-15.1.0-2025.12.27-rp2350/bin"
...
set(CFE_SYSTEM_PSPNAME      "rp2350-riscv-freertos")
set(OSAL_SYSTEM_BSPTYPE     "rp2350-riscv-freertos")
set(OSAL_SYSTEM_OSTYPE      "freertos")

set(LINKER_SCRIPT "${OSAL_SOURCE_DIR}/src/bsp/${OSAL_SYSTEM_BSPTYPE}/scripts/linker-flash.ld")
...
if ("${RISCV_MARCH}" STREQUAL "")
    set(RISCV_MARCH "rv32ima_zicsr_zifencei_zba_zbb_zbs_zbkb_zca_zcb_zcmp")
endif()
